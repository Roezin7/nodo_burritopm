...
export interface Catalogo {
  ...
  productos: { id: number; sku: string; nombre: string; linea: Linea; orden: number; tipo: string; unidad: string; precio: number | null; precio_pendiente: boolean; peso_caja_lb: number | null; ubicaciones_habilitadas?: number[] }[];
